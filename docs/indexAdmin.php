    ...
    <header class="bg-secondary">
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
            <div class="container-fluid">
              <a class="navbar-brand" href="indexAdmin.php">NHL Infos</a>
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="joueurAdmin.php?id=<?php echo $tab['idequipe']; ?>" class="btn btn-sm btn-primary">Joueur</a>
                        <a href="modifierequipe.php?id=<?php echo $tab["idequipe"]; ?>" class="btn btn-sm btn-danger">Modifier</a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
